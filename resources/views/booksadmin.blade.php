            ...
            <form method="POST" action="/lendBook">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select required name="lendee_id" class="form-select form-select" aria-label=".form-select example">
                    ...
                    <div class="mb-3">
                        ...
                        <select required name="book_id" class="form-select form-select" aria-label=".form-select example">
